...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['site-administrator', 'shop-owner', 'shop-manager', 'product-lister'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Shops', path: '/shops', entity: 'shop', service: AccessServiceEnum.PROJECT, icon: FiBox },
